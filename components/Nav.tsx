        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link href="/">
              <div className="flex items-center cursor-pointer group">
                ...
                <div className="h-9 w-9 bg-[#08CFF9] rounded-md mr-3 flex items-center justify-center text-slate-900 font-bold shadow-md group-hover:bg-[#F7EB01] transition-all duration-300">
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-2">
              ...
              <motion.div
                ...
                className="relative px-3 py-1.5 mr-2 rounded-md bg-slate-800 border border-slate-700 text-xs text-slate-300 cursor-pointer group"
              >
                <div className="flex items-center">
                ...
                <AnimatePresence>
                  {isPlayerCountHovered && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: 5 }}
                      className="absolute top-full mt-2 left-0 bg-slate-800 border border-slate-700 rounded-md p-3 shadow-lg w-52 z-10"
                    >
                      ...
                      className={`px-3 py-2 rounded-md text-sm font-medium flex items-center space-x-2 transition-all duration-200
                        ${
                          activeLink === link.href
                            ? "bg-slate-800 text-[#08CFF9] border-slate-700"
                            : "text-slate-300 hover:bg-slate-800/60 hover:text-[#08CFF9]"
                        }`}
                    >
                      {link.icon && (
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="ml-2 px-4 py-1.5 bg-[#08CFF9] text-slate-900 text-sm font-medium rounded-md hover:bg-[#F7EB01] shadow-sm hover:shadow transition-all duration-300 flex items-center"
              >
          ...
          <div className="md:hidden">
            <motion.button
              ...
              className="text-slate-300 hover:text-[#08CFF9] focus:outline-none p-2 rounded-md hover:bg-slate-800 border border-transparent hover:border-slate-700"
            >
        ...
        {isMenuOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <div className="px-3 py-2.5 flex items-center bg-slate-800 rounded-md mb-1 border border-slate-700">
                <span className="h-2 w-2 rounded-full bg-[#08CFF9] mr-2 animate-pulse"></span>
                ...
                >
                  <Link href={link.href}>
                    <div
                      ...
                      ${
                        activeLink === link.href
                          ? "bg-slate-800 text-[#08CFF9] border border-slate-700"
                          : "text-slate-300 hover:bg-slate-800/60 hover:text-[#08CFF9]"
                      }`}
                    >
              ...
              <motion.button
                ...
                initial="hidden"
                animate="visible"
                className="w-full mt-2 px-4 py-2.5 bg-[#08CFF9] text-slate-900 text-base font-medium rounded-md hover:bg-[#F7EB01] border border-slate-700/50 flex items-center justify-center space-x-2"
              >
                <FaDownload />
                <span>Play Now</span>
              </motion.button>
